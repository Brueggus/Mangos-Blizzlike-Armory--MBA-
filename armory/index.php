...
<td width="50%"></td><td>
<div class="deco">
<a class="logo" href="index.php"><span>Mangos Blizzlike Armory</span></a>
</div>
...
<a href="#" onClick="javascript: menuSelect('<?php echo $lang["characters"] ?>', 'characters'); return false;"><?php echo $lang["characters"] ?></a><a href="#" onClick="javascript: menuSelect('<?php echo $lang["guilds"] ?>', 'guilds'); return false;"><?php echo $lang["guilds"] ?></a><a href="#" onClick="javascript: menuSelect('<?php echo $lang["arena_teams"] ?>', 'arenateams'); return false;"><?php echo $lang["arena_teams"] ?></a><a href="#" onClick="javascript: menuSelect('<?php echo $lang["items"] ?>', 'items'); return false;"><?php echo $lang["items"] ?></a>
</div>
<q></q>
</div>
</div>
