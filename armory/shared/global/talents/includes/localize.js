...
var theURLtoCopy = "../www.worldofwarcraft.com/info/classes/"+ nlclass +"/talents.html";
...
function saveTheTemplate() {
	...
	w.document.write("../www.worldofwarcraft.com/info/classes/"+ nlclass +"/talents.html?" +templateString);		
...
function printableVersion() {
	...
	for (var blah = 0; blah != talent.length; blah++){
		...
		if (rankTop[blah][0] != 0) {
			w.document.write("<tr><td colspan=2 style = \"padding-left:18px\"><span id='displayRight"+ blah +"'><li><b>"+ talent[blah][1] +"</b> - rank <span id='modifyRankRight"+ blah +"' class=mySmallBlack>"+ rankTop[blah][0] +"</span>_3Cspan class=mySmallBlack>"+ talent[blah][2] +"</span><br></span></td></tr>");
