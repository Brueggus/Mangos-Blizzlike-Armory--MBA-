/*******            Resistances         ******/
var arcaneTooltip = '<span class="tooltipTitle">Arkanwiderstand '+ theCharacter.resistances.arcane.value + theCharacter.resistances.arcane.breakdown +'</span><span class="tooltipContentSpecial">Erh&ouml;ht die F&auml;higkeit, auf Arkanschaden basierenden Angriffen, Zaubern und F&auml;higkeiten zu widerstehen.<br/>Widerstand gegen Stufe '+ theCharacter.level +': <span class="myWhite">'+ theCharacter.resistances.arcane.rank +'</span></span>';
...
var fireTooltip = '<span class="tooltipTitle">Feuerwiderstand '+ theCharacter.resistances.fire.value + theCharacter.resistances.fire.breakdown +'</span><span class = "tooltipContentSpecial">Erh&ouml;ht die F&auml;higkeit, auf Feuerschaden basierenden Angriffen, Zaubern und F&auml;higkeiten zu widerstehen.<br/>Widerstand gegen Stufe '+ theCharacter.level +': <span class="myWhite">'+ theCharacter.resistances.fire.rank +'</span></span>';
var firePetBonus = "<span class = 'tooltipContentSpecial'>Erhöht den Widerstand Eures Begleiters um "+ theCharacter.resistances.fire.petBonus + "</span>";

var natureTooltip = '<span class="tooltipTitle">Naturwiderstand '+ theCharacter.resistances.nature.value + theCharacter.resistances.nature.breakdown +'</span><span class = "tooltipContentSpecial">Erh&ouml;ht die F&auml;higkeit, auf Naturschaden basierenden Angriffen, Zaubern und F&auml;higkeiten zu widerstehen.<br/>Widerstand gegen Stufe '+ theCharacter.level +': <span class="myWhite">'+ theCharacter.resistances.nature.rank +'</span></span>';
var naturePetBonus = "<span class = 'tooltipContentSpecial'>Erhöht den Widerstand Eures Begleiters um "+ theCharacter.resistances.nature.petBonus + "</span>";

var frostTooltip = '<span class="tooltipTitle">Frostwiderstand '+ theCharacter.resistances.frost.value + theCharacter.resistances.frost.breakdown +'</span><span class = "tooltipContentSpecial">Erh&ouml;ht die F&auml;higkeit, auf Frostschaden basierenden Angriffen, Zaubern und F&auml;higkeiten zu widerstehen.<br/>Widerstand gegen Stufe '+ theCharacter.level +': <span class="myWhite">'+ theCharacter.resistances.frost.rank +'</span></span>';
var frostPetBonus = "<span class = 'tooltipContentSpecial'>Erhöht den Widerstand Eures Begleiters um "+ theCharacter.resistances.frost.petBonus + "</span>";

var shadowTooltip = '<span class="tooltipTitle">Schattenwiderstand '+ theCharacter.resistances.shadow.value + theCharacter.resistances.shadow.breakdown +'</span><span class = "tooltipContentSpecial">Erh&ouml;ht die F&auml;higkeit, auf Schattenschaden basierenden Angriffen, Zaubern und F&auml;higkeiten zu widerstehen.<br/>Widerstand gegen Stufe '+ theCharacter.level +': <span class="myWhite">'+ theCharacter.resistances.shadow.rank +'</span></span>';
var shadowPetBonus = "<span class = 'tooltipContentSpecial'>Erhöht den Widerstand Eures Begleiters um "+ theCharacter.resistances.shadow.petBonus + "</span>";
...
var meleeExpertiseTitle = "Waffenkunde "+ theCharacter.melee.weaponSkill.mainHandWeaponSkill.value;
...
var meleeMainHandWeaponRating = "Waffenkundewertung "+ theCharacter.melee.weaponSkill.mainHandWeaponSkill.rating + " (+"+ theCharacter.melee.weaponSkill.mainHandWeaponSkill.additional +" Waffenkunde)";
/*var meleeOffHandWeaponSkill = "Weapon Skill "+ theCharacter.melee.weaponSkill.offHandWeaponSkill.value;
var meleeOffHandWeaponRating = "Waffenkundewertung "+ theCharacter.melee.weaponSkill.offHandWeaponSkill.rating;*/
...
var spellHasteRatingTooltip = "Increases the speed that your spells cast by "+theCharacter.spell.hasteRating.increasedHastePercent+"%";
...
var defensesDefenseDecreasePercent = "Verringert die Chance, dass Ihr getroffen oder kritisch getroffen werdet, um "+ theCharacter.defenses.defense.decreasePercent +"%";
var defensesDefenseDisplay = "Verteidigung: ";

var defensesDodgeTitle = "Ausweichwertung ";
var defensesDodgePercent = "Erhöht die Ausweichchance um "+ theCharacter.defenses.dodge.increasePercent +"%";
var defensesDodgeDisplay = "Ausweichen: ";

var defensesParryTitle = "Parierwertung ";
var defensesParryPercent = "Erhöht die Parierchance um "+ theCharacter.defenses.parry.increasePercent +"%";
var defensesParryDisplay ="Parieren: ";

var defensesBlockTitle = "Blockwertung ";
var defensesBlockPercent = "Erhöht die Blockchance um "+ theCharacter.defenses.block.increasePercent +"%";
...
var defensesResilienceDamagePercent = "Verringert den Manaentzugeffekt sowie den Schaden durch kritische Treffer um "+ theCharacter.defenses.resilience.damagePercent +"%.<br />Verringert die Chance, dass Feinde einen kritischen Treffer gegen Euch erzielen, um "+ theCharacter.defenses.resilience.hitPercent +"%.";
