...
function roleCasterDps() {
	...
	addPredefinedAdvOpt('spellDamage');
	deleteRest();	
	setOr();
}

function roleHealer() {
	addPredefinedAdvOpt('spellHealing');
...
function roleCasterDpsMage() {
	addPredefinedAdvOpt('spellCritRating');
	addPredefinedAdvOpt('spellDamage');
	addPredefinedAdvOpt('spellDamageArcane');
	addPredefinedAdvOpt('spellDamageFire');
	addPredefinedAdvOpt('spellDamageFrost');
	deleteRest();	
	setOr();	
}
...
function roleCasterDpsPaladin() {
	addPredefinedAdvOpt('spellDamage');
	addPredefinedAdvOpt('spellDamageHoly');
	deleteRest();			
	setOr();		
}
...
function roleCasterDpsPriest() {
	addPredefinedAdvOpt('spellCritRating');	
	addPredefinedAdvOpt('spellDamage');
	addPredefinedAdvOpt('spellDamageShadow');
	deleteRest();			
	setOr();		
}
...
function roleCasterDpsShaman() {
	addPredefinedAdvOpt('spellCritRating');
	addPredefinedAdvOpt('spellDamage');
	addPredefinedAdvOpt('spellDamageNature');
	deleteRest();	
	setOr();		
}
