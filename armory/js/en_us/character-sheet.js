...
var meleeExpertiseTitle = "Expertise "+ theCharacter.melee.weaponSkill.mainHandWeaponSkill.value;
...
var meleeMainHandWeaponRating = "Expertise rating "+ theCharacter.melee.weaponSkill.mainHandWeaponSkill.rating + " (+"+ theCharacter.melee.weaponSkill.mainHandWeaponSkill.additional +" expertise)";
...
var rangedHitRatingIncreasedPercent = "Increases your ranged chance to hit a target of level "+ theCharacter.level +" by "+theCharacter.ranged.hitRating.increasedHitPercent +"%";
...
var defensesDefenseDecreasePercent = "Decreases chance to be hit and critically hit by "+ theCharacter.defenses.defense.decreasePercent +"%";
var defensesDefenseDisplay = "Defense: ";

var defensesDodgeTitle = "Dodge Rating ";
var defensesDodgePercent = "Increases your chance to Dodge by "+ theCharacter.defenses.dodge.increasePercent +"%";
var defensesDodgeDisplay = "Dodge: ";

var defensesParryTitle = "Parry ";
var defensesParryPercent = "Increases your chance to Parry by "+ theCharacter.defenses.parry.increasePercent +"%";
var defensesParryDisplay ="Parry: ";

var defensesBlockTitle = "Block Rating ";
var defensesBlockPercent = "Increases your chance to Block by "+ theCharacter.defenses.block.increasePercent +"%";
var defensesBlockDisplay = "Block: ";

var defensesResilienceTitle = "Resilience ";
var defensesResilienceHitPercent = "Decreases chance of enemy scoring a critical hit on you by "+ theCharacter.defenses.resilience.hitPercent +"%.";
var defensesResilienceDamagePercent = "Reduces damage taken from critical strikes by "+ theCharacter.defenses.resilience.damagePercent +"%.<br />Reduces damage taken from periodic damage by "+ theCharacter.defenses.resilience.hitPercent +"%.";
